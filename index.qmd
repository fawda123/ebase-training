...
-   [EBASE website](https://fawda123.github.io/ebase){target="_blank"}
...
Please visit the [setup](setup.qmd) page for instructions on preparing for this workshop. You will be required to install R, RStudio, JAGS, and several R packages prior to the workshop.
